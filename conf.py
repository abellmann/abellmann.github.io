...
BLOG_AUTHOR = "Andreas Bellmann"  # (translatable)
BLOG_TITLE = "Engineering for DevOps"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://abellmann.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://abellmann.github.io/"
BLOG_EMAIL = "andreas.bellmann@gmail.com"
BLOG_DESCRIPTION = "Software Engineering and DevOps Experiences"  # (translatable)
